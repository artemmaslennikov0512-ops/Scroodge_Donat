-- AlterTable
ALTER TABLE "Streamer" ADD COLUMN     "user_id" TEXT;
...
-- AddForeignKey
ALTER TABLE "Streamer" ADD CONSTRAINT "Streamer_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
